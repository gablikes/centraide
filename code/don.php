			...
			<fieldset>
				...
				<div class="fieldset">
					...
					<p>
						...
						<input type="text" name="champTelBur1" id="champTelBur1" value="">
						<input type="text" name="champTelBur2" id="champTelBur2" value="">
						<input type="text" name="champTelBur3" id="champTelBur3" value="">
					</p>
					<p>
						<label for="champTel1">Domicile</label>
						<input type="text" name="champTelDom1" id="champTelDom1" value="">
						<input type="text" name="champTelDom2" id="champTelDom2" value="">
						<input type="text" name="champTelDom3" id="champTelDom3" value="">
					</p>
				</div>
				<div class="fieldset">
					<h3>Courriel</h3>
